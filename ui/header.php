        ...
        <nav id="me-navbar">
            <div class="nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down">
                    <li><a class="dropdown-button" href="#!" data-activates="dropdown1"><?php echo ($_SESSION["username"]) ? $_SESSION["username"] : ''?> <i class="material-icons right">account_circle</i></a></li>
                </ul>
            </div>
        </nav>
    </div>
            ...
            <li>
                ...
                <div class="collapsible-body">
                    <ul>
                        ...
                        <li><a href="#" class="waves-effect waves-default">Member Tree</a></li>
                    </ul>
                </div>
            </li>
            <li>
                ...
                <div class="collapsible-body">
                    <ul>
                        <li><a href="#" class="waves-effect waves-default">Transfer</a></li>
                        <li><a href="#" class="waves-effect waves-default">Withdraw</a></li>
                        <li><a href="#" class="waves-effect waves-default">Ref Earn History</a></li>
